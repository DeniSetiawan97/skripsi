            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="header slideDown">
                        <div class="logo"><img src="assets/images/user.png" alt="Nexa"></div>
                ...
                <div class="col-lg-12">
                    ...
                    <a href="../signup/signup.php" class="btn btn-raised btn-default waves-effect">SIGN UP</a>                        
                </div>
                </form>
                <div class="col-lg-12 m-t-20">
                    <a class="" href="forgot.php">Forgot Password?</a></br>
